...
urlpatterns = [
    ...
    url(r'^api/confirm-email/$', views.ConfirmEmailView.as_view(),
        name='confirm_email'),
    url(r'^new_key_activation/', views.NewKeyActivationView.as_view(),
        name='new_key_activation'),
    url(r'^api/reset-password/$', views.ResetPasswordView.as_view(),
        name='reset_password'),
    url(
        r'^api/reset/$', views.PasswordResetConfirmView.as_view(),
